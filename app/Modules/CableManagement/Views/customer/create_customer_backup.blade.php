...
$(document).ready(function() {
    ...
    $('#add_customer_form').validate({
        ...
        messages: {
            ...
            road: {required: "Please select road"},
            house: {required: "Please select house"}
        }
    });
		...
		<div class="box-body">
			<div class="col-md-4">
				<div class="form-group">
	                ...
	                <input type="text" class="form-control" name="name" id="customer_name" placeholder="Subscriber Name">
                </div>
                <div class="form-group">
	                <label>Phone*</label>
            	...
            	@endif
            	@if(Entrust::hasRole('distributor'))
					<div class="form-group">
                        <label>Sub Distributor</label>
                        <select class="form-control select2" name="sub_distributors_id" id="sub_distributors_id"></select>
                    </div>

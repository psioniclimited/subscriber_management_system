            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="pair_duration" id="pair_duration" placeholder="Enter pair duration"/>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                      <div class="radio">
                        <label>
                          <input type="radio" name="deactivate_option" id="deactivate_option_1" value="temporarily_deactivate" checked>
                          Temporarily Deactivate
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="deactivate_option" id="deactivate_option_2" value="permanently_deactivate">

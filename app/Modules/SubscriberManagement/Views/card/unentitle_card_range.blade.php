...
$(document).ready(function () {
    ...
    $('#unentitle_card_range_form').validate({
        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Unentitle Card Range</h3>
                </div>
                <!-- /.box-header -->
                <!-- form starts here -->
                {!! Form::open(array('url' => 'unentitle_card_range_process', 'id' => 'unentitle_card_range_form', 'class' => 'form-horizontal')) !!}
                <div class="box-body">
                    <div class="col-md-4">

...
$(document).ready(function () {
    ...
    $('#edit_distributor_form').validate({
...
<section class="content">
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">Distributor Edit Page</h3>
        </div><!-- /.box-header -->
        <!-- form starts here -->
        {!! Form::open(array('url' => array('edit_distributor_process', $distributor->id), 'id' => 'edit_distributor_form', 'class' => 'form-horizontal', 'method'=>'PUT')) !!}
        <div class="box-body">
            <div class="col-md-4">
                <div class="form-group">
                    <label for="fullname" class="control-label">Fullname*</label>
                    <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Enter fullname" value="{{$distributor->name}}">
                </div>
                <div class="form-group">
                    <label for="uemail" class="control-label">Email*</label>
                    <input type="email" class="form-control" id="uemail" name="uemail" placeholder="Enter email" value="{{$distributor->email}}">
                </div>
                 ...
                 <div class="form-group">
                    ...
                    <select name="territory" id="territory" class="form-control">
                        @foreach($territory as $terr)
                            <option value="{{$terr->id}}"@if($terr->id == $distributor->territory_id) selected @endif>{{$terr->name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
